function Footer() {
    return (
        <footer className="bg-dark-900 border-t border-gray-800 text-white py-12 mt-auto">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    <div className="col-span-1 md:col-span-1">
                        <h3 className="text-2xl font-bold bg-gradient-to-r from-brand-400 to-accent-400 bg-clip-text text-transparent mb-4">
                            LuxeDrive
                        </h3>
                        <p className="text-gray-400 text-sm leading-relaxed">
                            Experience the future of automotive dealership. Secure, transparent, and decentralized.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            ...
                            <li><a href="#" className="hover:text-brand-400 transition-colors">Digital Assets</a></li>
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center hover:bg-brand-600 transition-colors">
                ...
                <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
                    <p>&copy; 2024 LuxeDrive Decentralized Dealership. All rights reserved.</p>
